...
const BsyCard=()=>{
    ...
    return (
        <article class="prose">
  <div class="shadow-2xl  mr-10 my-10 px-10 py-15  w-full  text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
    <h5 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">BHAKT SHAKTI YOG FOUNDETION</h5>
    <p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Voluntary Association of Agricultural General Development Health and Reconstruction Alliance
.</p>
